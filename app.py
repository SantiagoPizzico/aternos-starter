...
COOKIE_HSID     = os.environ.get("COOKIE_HSID", "")
COOKIE_SSID     = os.environ.get("COOKIE_SSID", "")
COOKIE_APISID   = os.environ.get("COOKIE_APISID", "")
COOKIE_SAPISID  = os.environ.get("COOKIE_SAPISID", "")
COOKIE_SID      = os.environ.get("COOKIE_SID", "")
COOKIE_SIDCC    = os.environ.get("COOKIE_SIDCC", "")
